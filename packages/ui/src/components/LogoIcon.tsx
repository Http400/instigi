...
export const LogoIcon: React.FC<LogoIconProps> = (props) => {
  return (
    ...
    >
      ...
      <rect x="102" y="75" width="72" height="260" rx="20" fill="currentColor" />
      <rect x="240" y="0" width="84" height="410" rx="20" fill="currentColor" />
      <rect x="410" y="75" width="72" height="260" rx="20" fill="currentColor" />
